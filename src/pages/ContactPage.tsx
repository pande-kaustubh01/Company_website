...
export const ContactPage: React.FC<ContactPageProps> = ({
  ...
  const [formData, setFormData] = useState<ConsultationFormData>({
    ...
    areaOfInterest: 'Cloud Migration',
  ...
  const areasOfInterest = [
    'Cloud Migration & VMware Modernization',
      ...
      <section className="relative py-16 md:py-24 bg-[#0A0A0B] border-b border-white/10 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed font-normal">
            Whether you're planning a cloud migration, evaluating Generative AI, modernizing your platform, or looking for architecture expertise, let's start with a conversation.
          </p>
        </div>
      </section>
              ...
              {submitted ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <div className="bg-[#0A0A0B] p-4 rounded-sm border border-white/10 text-xs text-slate-400 max-w-md mx-auto text-left space-y-1 font-mono">
                    ...
                    <div>2. Our Principal Architect will review your requirements and schedule an initial discovery call.</div>
                  </div>
                  <div className="pt-4">
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="CTO / Head of Cloud / Director of IT"
                  ...
                  <div>
                    ...
                    <textarea
                      required
                      rows={4}
                      placeholder="Please describe your current infrastructure, challenges, timelines, or specific technologies (AWS, Azure, Bedrock, Kubernetes, etc.) you are considering..."
